...
$sql = "SELECT loc.id_cart,loc.id_order, pc.firstname, pc.lastname, loc.carrier, loc.sitio,pc.customerID, CONCAT(pc.customerID,', ',loc.id_order) as referencia, '03' as payment, loc.paqueterias as shipping FROM lista_ordenes_referencia loc ";
...
/*
UPDATE `lista_ordenes_credito` SET `cot` = '', cotizacion = 0;
UPDATE `lista_ordenes_tarjeta` SET `cot` = '', cotizacion = 0;
UPDATE `lista_ordenes_referencia` SET `cot` = '', cotizacion = 0;
 */
