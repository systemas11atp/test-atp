...
class ProductCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            /* Lang fields */
            'meta_description' => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'size' => 4000],
            'meta_keywords' => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'size' => 255],
            'meta_title' => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'size' => 4000],
            'link_rewrite' => [
                'type' => self::TYPE_STRING,
                'lang' => true,
