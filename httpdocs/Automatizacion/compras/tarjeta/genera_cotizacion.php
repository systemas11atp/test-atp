...
$sql = "SELECT lot.id_cart,lot.id_order, pc.firstname, pc.lastname, lot.carrier, lot.sitio,pc.customerID, CONCAT(pc.customerID,', ',lot.id_order) as referencia, '28' as payment, lot.paqueterias as shipping ";
...
$sql .= "WHERE lot.cotizacion = 0 AND lot.cot = '' ORDER BY lot.id_order DESC";
