...
class CustomerCore extends ObjectModel
{
    ...
    /** @var string RFC customer*/
    public $RFC;

    /** @var string customerID customer*/
    public $customerID;

    /** @var string bank_reference customer*/
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'RFC' => ['type' => self::TYPE_STRING, 'size' => 20],
            'customerID' => ['type' => self::TYPE_STRING, 'size' => 20],
            'bank_reference' => ['type' => self::TYPE_STRING, 'size' => 20],
