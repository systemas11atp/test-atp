...
$(document).ready(() => {
  ...
  /* roll over cart */
   $('div').on({
    mouseenter: function() {
      $(this).parent().find('.cart-summary').stop(true,true).slideDown(300);
      $(this).stop( true, true).addClass('open');
    },
    mouseleave: function() {
      $(this).parent().find('.cart-summary').stop(true,true).delay(1000).slideUp(300);
      $(this).delay(1000).queue(function() { $(this).removeClass('open'); $(this).dequeue(); });
    }
  }, ".wp-expand");
