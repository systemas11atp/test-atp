...
<div class="delivery-options-list">
  ...
  <div class="form-fields">
    ...
    <div class="delivery-options">
      {foreach from=$delivery_options item=carrier key=carrier_id}
        ...
        <div class="row delivery-option" id="envio_{$carrier.id}">
          <div class="col-sm-1">
      ...
      <script>
        miArreglo.push([{$carrier.id}, {$id_address}])
      </script>
      {/foreach}
    </div>
    {/block}
  ...
  <button type="submit" class="continue btn btn-primary float-xs-right" name="confirmDeliveryOption" disabled="true" value="1">
