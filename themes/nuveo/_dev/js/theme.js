...
import './lib/animsition.min.js';
import './lib/jquery.cookie.js';
import './lib/jquery.bxslider.min.js';
...
$(document).ready(() => {
  ...
  const form = new Form();
  const topMenuEl = $('.menu-wrapper .js-top-menu ul[data-depth="0"]');
  const verticalMenuEl = $('.js-vertical-menu ul[data-depth="0"]');
  const dropDown = new DropDown(dropDownEl);
  const topMenu = new TopMenu(topMenuEl);
  const verticalMenu = new VerticalMenu(verticalMenuEl);
